...
const Home = () => {
  ...
  return (
    ...
    <div className="home-wrapper">
      ...
      {/* Nueva sección: Fuel Developers */}
      <section id="fuel-devs" className="fuel-home-section">
        <div className="fuel-home-inner">
          <div className="fuel-home-content">
            <div className="fuel-home-badge">
              <div className="fuel-badge-dot" />
              Proyecto estudiantil
            </div>
            <h2>Desarrollado con persistencia estudiantil</h2>
            <p>
              Este sistema empezó con: <strong>"No puede ser tan difícil..."</strong><br />
              Spoiler: sí era tan difícil.
            </p>
            <p>
              47 noches de debugging, 156 búsquedas desesperadas y 1 momento épico final.<br />
              Aquí tienes DigitalHub. Gratis para siempre.
            </p>
            <Link to="/fuel-devs" className="btn-fuel-home">
          ...
          <div className="fuel-home-visual">
            <svg viewBox="0 0 300 200" xmlns="http://www.w3.org/2000/svg" style={{width:"100%",height:"200px"}}>
              <defs>
                <linearGradient id="fuelBg" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="rgba(127,90,240,0.1)"/>
                  <stop offset="100%" stopColor="rgba(44,185,176,0.05)"/>
                </linearGradient>
              </defs>
              <rect width="300" height="200" fill="url(#fuelBg)" rx="20"/>
              <circle cx="150" cy="100" r="60" fill="none" stroke="rgba(127,90,240,0.3)" strokeWidth="2" strokeDasharray="8,4"/>
              <circle cx="150" cy="100" r="30" fill="rgba(127,90,240,0.1)" stroke="#7f5af0" strokeWidth="2"/>
              <text x="150" y="95" textAnchor="middle" fill="#7f5af0" fontSize="12" fontWeight="700">Fuel</text>
              <text x="150" y="110" textAnchor="middle" fill="#c9a8ff" fontSize="12" fontWeight="600">Devs</text>
              <circle cx="80" cy="60" r="8" fill="rgba(74,222,128,0.6)"/>
              <circle cx="220" cy="140" r="6" fill="rgba(224,64,251,0.6)"/>
              <circle cx="60" cy="140" r="5" fill="rgba(44,185,176,0.6)"/>
              <circle cx="240" cy="60" r="7" fill="rgba(250,204,21,0.6)"/>
            </svg>
          </div>
        </div>
      </section>
