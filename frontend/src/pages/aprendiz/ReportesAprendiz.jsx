                ...
                {seleccionado.archivo && (
                  ...
                  <div className="detalle-item" style={{flexDirection:'column',alignItems:'flex-start',gap:'8px'}}>
                    ...
                    {/\.(jpg|jpeg|png)$/i.test(seleccionado.archivo) ? (
                      ...
                      <img src={archivoUrl(seleccionado.archivo)} alt="evidencia" style={{maxWidth:'100%',borderRadius:'10px',border:'1px solid rgba(127,90,240,0.3)'}}/>

                    ) : (

                      <a href={archivoUrl(seleccionado.archivo)} target="_blank" rel="noreferrer" style={{color:'#c9a8ff',fontSize:'13px'}}>Ver archivo adjunto</a>
